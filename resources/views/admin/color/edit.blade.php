            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" value="{{ $color->name }}" name="name" id="name" class="form-control" placeholder="Name">
                  <p></p>	
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" value="{{ $color->slug }}" name="slug" id="slug" class="form-control" placeholder="Slug" readonly>	
                  <p></p>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <div class="input-group my-colorpicker2">
                    <input value="{{ $color->color }}" name="color" id="color" type="text" class="form-control">
  ...
  <script>
    ...
    /**Ajax for the form*/
      $('#colorsForm').submit(function(event){
        ...
        $.ajax({
          url: '{{ route("colors.update",$color->id) }}', //post create route
          type: 'put',
