    ...
    <div class="container-fluid my-2">
      <div class="row mb-2">
        ...
        <div class="col-sm-6 text-right">
          <a href="{{ route('sizes.create') }}" class="btn btn-primary">New Sizes</a>
        </div>
      </div>
    </div>
    <!-- /.container-fluid -->
        ...
        <form action="" method="get">
          ...
          <div class="card-header">
            ...
            <div class="card-title">
              <button onclick="window.location.href='{{ route('sizes.index') }}'" class="btn btn-default btn-sm">Reset</button>
            </div>
                ...
                @foreach($sizes as $size)
                  <tr>
                    ...
                    <td class="text-right">
                      ...
                      <!-- delete btn-->
                      <a onclick="deleteColor({{ $size->id }})" class="text-danger w-4 h-4 mr-1">
