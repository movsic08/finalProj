<ul id="account-panel" class="nav nav-pills flex-column" >
  ...
  <li class="nav-item @if(Request::segment(2) == 'my-orders' || Request::segment(2) == 'order-detail') active @endif">
  ...
  <li class="nav-item @if(Request::segment(2) == 'my-wishlist') active @endif" >
  ...
  <li class="nav-item @if(Request::segment(2) == 'change-password') active @endif">
