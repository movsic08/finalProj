            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <textarea name="description" id="description" cols="10" rows="3" class="form-control summernote">{!! $coupon->description !!}</textarea>
                  <p></p>
                </div>
              </div>
  ...
  <script>
    ...
    /**Ajax for the form*/
      $('#discountForm').submit(function(event){
        ...
        $.ajax({
          url: '{{ route("coupons.update",$coupon->id) }}', //post create route
          type: 'put',
