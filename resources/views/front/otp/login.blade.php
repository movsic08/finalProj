    ...
    @endif
      ...
      <div class="login-form">    
          <form action="{{ route('otp.generate') }}" method="post" class="text-center" id="otp_form">
            @csrf
              <h4 class="modal-title">Phone Number Verification via OTP</h4>
              <div class="form-group">
                  <input type="text" class="form-control text-center" placeholder="Phone number" name="mobile_no" id="mobile_no" value="{{ Auth::user()->phone }}">
                  <p></p>
              </div>
              
            
              <input type="submit" class="btn btn-dark btn-block btn-lg" value="Send OTP Verification">     
