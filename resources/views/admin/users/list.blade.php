        ...
        <form action="" method="get">
          ...
          <div class="card-header">
            ...
            <div class="card-title">
              <button onclick="window.location.href='{{ route('users.index') }}'" class="btn btn-default btn-sm">Reset</button>
            </div>
          ...
          <table class="table table-hover text-nowrap">
            <thead>
              <tr>
                ...
                <th class="text-nowrap">Phone Verified</th>
                ...
                @foreach($users as $user)
                  <tr>
                    ...
                    <td>
                      @if($user->role == 1)
                        Customer
                      @elseif($user->role == 2 && $user->main_role == 1)
                        Admin 
                      @elseif($user->role == 2 && $user->main_role == 2)
                        Super Admin
                      @endif
